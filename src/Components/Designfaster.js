...
import DemoRadialBar from "./DemoRadialBar.js"
const Designfaster = () => {
    ...
    {/* title  */}
      ...
      <div className="bg-blue" style={{ color: "white" }}>
        ...
        <div>
          ...
          <p className="compare" style={{ fontSize: "0.7rem" }}>
            Compared to $ 28,504 last year
          </p>
        </div>
      </div>
      <div className="types acc-data">
        <div>
          Travel <span>754</span>
          2540
        </div>
        <div>
          Presentation <span>658</span>2307
        </div>
        <div>
          Research <span>369</span>9021
        </div>
      </div>
    </div>
  );
